...
var verifytoken = exports.verifytoken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var token, decoded, email, _yield$pool$query, _yield$pool$query2, rows;
...
var isConductor = exports.isConductor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return _db.pool.query("SELECT * FROM usuario WHERE email = ?", [req.email]);
        case 3:
  ...
  return function isConductor(_x4, _x5, _x6) {
...
var isAdminOrConductor = exports.isAdminOrConductor = /*#__PURE__*/function () {
  ...
  return function isAdminOrConductor(_x10, _x11, _x12) {
