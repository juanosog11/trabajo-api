...
exports.getUsuarios = exports.getUsuarioEmail = exports.crearUsuario = exports.borrarUsuario = exports.actualizarUsuario = void 0;
...
var getUsuarioEmail = exports.getUsuarioEmail = /*#__PURE__*/function () {
  ...
  return function getUsuarioEmail(_x3, _x4) {
...
var actualizarUsuario = exports.actualizarUsuario = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var email, _req$body2, nombre, apellido, telefono, contraseña, rol, _yield$pool$query7, _yield$pool$query8, result, _yield$pool$query9, _yield$pool$query10, rows;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          email = req.params.email;
          _req$body2 = req.body, nombre = _req$body2.nombre, apellido = _req$body2.apellido, telefono = _req$body2.telefono, contraseña = _req$body2.contraseña;
          rol = 'Usuario';
          _context4.prev = 3;
          _context4.next = 6;
          return _db.pool.query("UPDATE usuario SET nombre = IFNULL(?, nombre), apellido = IFNULL(?, apellido), telefono = IFNULL(?, telefono), contraseña = IFNULL(?, contraseña), rol = IFNULL(?, rol) WHERE email = ?", [nombre, apellido, telefono, contraseña, rol, email]);
        case 6:
...
var borrarUsuario = exports.borrarUsuario = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var email, _yield$pool$query11, _yield$pool$query12, result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return _db.pool.query("DELETE FROM usuario WHERE email = ?", [email]);
        case 4:
  ...
  return function borrarUsuario(_x9, _x10) {
