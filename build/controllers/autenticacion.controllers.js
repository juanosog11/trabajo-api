...
var signin = exports.signin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, email, contraseña, _yield$pool$query9, _yield$pool$query10, rows2, iguales, id, token;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body2 = req.body, email = _req$body2.email, contraseña = _req$body2.contraseña;
          _context2.prev = 1;
          _context2.next = 4;
          return _db.pool.query("SELECT * FROM usuario WHERE email = ?", [email]);
        case 4:
